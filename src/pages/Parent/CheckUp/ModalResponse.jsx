    ...
    >
          ...
          <Space direction="vertical" className="w-full">
            ...
            >
              <Radio value="yes" className="w-full">
                ...
                >
                  I consent to my child receiving this check up
                </p>
              </Radio>
            </div>
            ...
            >
              <Radio value="no" className="w-full">
                ...
                >
                  I do not consent to my child receiving this check up
                </p>
              </Radio>
            </div>
          </Space>
      ...
      {isDeclinedSelected && (
        <div className="mb-4">
          ...
          <TextArea
            rows={4}
            placeholder="Please provide a detailed reason for declining this checkup (required)"
