...
function Home() {
  return (
    ...
    <div className="container w-full h-[100px] mt-20 mb-4">
          ...
          <div className="flex gap-6 p-6 w-1/2">
            ...
            <div className="flex flex-col gap-6 pt-[90px]">
              ...
              <p className="text-[20px]">
                We provide health care services for students at school, allowing
                parents to easily send medication and health information for
                their children to the school. Our healthcare staff will ensure
                that students receive the correct medication and timely
                treatment, ensuring their health throughout their learning
                journey.
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-end gap-6 pt-[90px]">
          ...
          <div>
            ...
            <p className="text-[20px] w-[900px] mt-[30px]">
              ...
              medicines, basic medical equipment, and school first aid kits. All
              items are sourced from certified suppliers and comply with
              Ministry of Health regulations, supporting schools in creating a
              safe learning environment and effectively caring for students’
              health.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between gap-6 mt-[70px] pl-6">
          <div className="flex gap-6 w-1/2">
            ...
            <div className="flex flex-col gap-6 pt-[90px]">
              ...
              <p className="text-[20px]">
                We care beyond the classroom. With certified supplies, trained
                medical staff, and a fully equipped health room, we ensure every
                student’s well-being is in safe hands — every day.
              </p>
            </div>
          </div>
        </div>

        <div className="relative mt-10 w-full h-[500px] mb-100">
          <img
            src={bs3}
            alt="background"
          ...
          >
            ...
            <div className="flex justify-normal gap-[100px] text-black text-2xl pl-[50px]">
              ...
              <div className="flex flex-col items-center">
                <img src={medicine} alt="" className="w-[100px] h-[100px]" />
                <p className="font-serif mt-2 text-center  whitespace-nowrap">
