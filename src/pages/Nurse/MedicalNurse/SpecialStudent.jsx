...
import { completeMeeting } from "../../../redux/checkupNurse/completeMeeting/completeMeetingSlice";
...
function SpecialStudent() {
  ...
  const handleComplete = (values) => {
    const isConfirmed = window.confirm("Do you want to confirm?");
    if (isConfirmed) {
      dispatch(completeMeeting(values?.id));
    }
  };
