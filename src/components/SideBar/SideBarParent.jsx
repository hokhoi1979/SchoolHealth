  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex items-center gap-4 mt-1 ml-2 hover:bg-[#EFEEEE] p-2 rounded-xl ${
            click === "password" ? "bg-[#EFEEEE] p-2 rounded-xl text-black" : ""
          } ${toggle && "justify-center"}`}
          style={{ cursor: "pointer" }}
        >
          <svg
